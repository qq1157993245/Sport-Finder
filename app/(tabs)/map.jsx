...
const MapScreen = () => {
  ...
  useEffect(() => {
    ...
    // Use onSnapshot for updates
    onSnapshot(coordinatesCollection, (querySnapshot) => {
      const fetchedCoords = [];
            ...
            <Callout>
              <View style={styles.callout}>
                ...
                <Text style={styles.calloutDescription}>
                  Players: {marker.playersCount}/{marker.playersCount}
                </Text>
                <Text style={styles.calloutDescription}>
                  Game Duration: {marker.gameDuration} {marker.gameDuration === 1 ?
                    'hour' : 'hours'}
                </Text>
